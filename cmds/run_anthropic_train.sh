...
echo "[SCRIPT] run_anthropic_train_only.sh :: TRAIN (Anthropic executor, OpenAI scorer/optimizer)"
...
for dataset in "${DATASETS[@]}"; do
  ...
  train_desc="TRAIN [anthropic|openai|openai | $eval_dir | $dataset]"
